...
app.use(cors({
  origin: isProd ? 'https://artsy-android-backend.wl.r.appspot.com/'
                 : 'http://10.0.2.2:3000',
  credentials: true
}));
...
// at top of index.js (below your CLIENT_ID/SECRET)
...
app.get('/api/search_artist', async (req, res) => {
  console.log("Received request to /api/search_artist");
